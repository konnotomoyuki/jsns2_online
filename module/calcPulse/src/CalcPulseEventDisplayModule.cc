#include "CalcPulseEventDisplayModule.hh"
#include "DBObject.hh"
...
CalcPulseEventDisplayModule::CalcPulseEventDisplayModule()
  : CanvasModule ("CalcPulseEventDisplay")
{
}
...
Bool_t CalcPulseEventDisplayModule::Initialize()
{
...
Bool_t CalcPulseEventDisplayModule::BeginRun()
{
  //StoredObject<RawData::Event> ev;
  return true;
}

Bool_t CalcPulseEventDisplayModule::ProcessEvent()
{
...
Bool_t CalcPulseEventDisplayModule::EndRun()
{
  return true;
}

Bool_t CalcPulseEventDisplayModule::Finalize()
{
  return true;
}
